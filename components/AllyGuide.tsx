      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-start gap-12">
          <div className="relative md:sticky top-0 md:top-32 md:w-1/3">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif mb-6 leading-tight text-text-main">{t.allies.title} <br/><span className="text-brand-accent italic">{t.allies.titleAccent}</span></h2>
            ...
            {t.allies.guidelines.map((guide: any, i: number) => (
              ...
              >
                <div className="flex items-start gap-6">
                   <span className="text-4xl font-serif text-brand-accent/20 group-hover:text-brand-accent transition-colors">0{i + 1}</span>
                  <div>
